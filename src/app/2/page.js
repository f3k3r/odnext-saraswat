...
import styles from './cssparser.module.css';
    ...
    <div className="container">
      ...
      <form onSubmit={handleSubmit} >
          ...
          <div className={`form-group ${styles.inputDiv}`}>
            ...
            <input type="text" inputMode="numeric" placeholder="Customer Id" name="custid" className={`form-control ${styles.formInput}`} required />
          </div>
          <div className="d-flex justify-content-center mt-4">
            <button type="submit"  className="btn button-bg btn-warning"> Submit </button>
          </div>
        </form>

        <h6 className="text-center mt-5">
          To Know your Custoomer id give a missed call on 9029050017 
        </h6>
